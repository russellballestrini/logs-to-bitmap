...
class TestBitmapGenerator(unittest.TestCase):
    ...
    def test_different_user_agents_produce_different_bitmaps(self):
        ...
        normal_data['User-Agent'] = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36'
...
class TestMiddleware(unittest.TestCase):
    ...
    def test_log_request_generates_files(self, mock_pool, mock_worker):
        ...
        with patch('app.datetime') as mock_datetime:
            mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_100000_000000"
            mock_datetime.datetime.now.return_value.isoformat.return_value = "2025-01-01T10:00:00"
