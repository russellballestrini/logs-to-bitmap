...
class TestEndToEndWorkflow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for dir_path in [self.test_logs_dir, self.test_images_dir, self.test_models_dir]:
        ...
        test_requests = [
            {
                ...
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' if i != 5 else 'curl/7.68.0',
                'Method': 'GET',
...
class TestCrossDatasetConsistency(unittest.TestCase):
    ...
    def create_synthetic_dataset(self, output_dir, base_timestamp="2025-01-01T10:00:00", anomaly_positions=None):
    ...
    def test_cross_dataset_detection(self):
        ...
        self.assertGreater(len(detected_known), 0, 
